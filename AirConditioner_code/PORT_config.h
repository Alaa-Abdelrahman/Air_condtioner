...
/* VALUES:
		-0 FOR LOW IF OUTPUT , 0 FOR FLOATING IF INPUT
		-1 FOR HIGH IF OUTPUT, 1 FOR PULL UP IF INPUT
...
#define PORTB_PIN1_INIT_VAL     1
#define PORTB_PIN2_INIT_VAL     1
#define PORTB_PIN3_INIT_VAL     1
#define PORTB_PIN4_INIT_VAL     1
#define PORTB_PIN5_INIT_VAL     1
#define PORTB_PIN6_INIT_VAL     1
#define PORTB_PIN7_INIT_VAL     1
